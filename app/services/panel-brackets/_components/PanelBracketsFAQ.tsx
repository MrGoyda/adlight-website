// app/services/panel-brackets/_components/PanelBracketsFAQ.tsx
...
export default function PanelBracketsFAQ() {
  return (
    <section className="py-24 bg-slate-50 border-t border-slate-200/80">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500">Всё, что нужно знать о заказе и установке консольных вывесок</p>
        </div>
        
        <div className="space-y-4">
          {panel_bracketsDetails.faqs.map((item, index) => (
            <details 
              key={index} 
              itemScope
              itemProp="mainEntity"
