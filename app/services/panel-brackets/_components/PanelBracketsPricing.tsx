// app/services/panel-brackets/_components/PanelBracketsPricing.tsx

import Link from "next/link";
import { Calculator } from "lucide-react";
import { panel_bracketsDetails } from "@/dictionaries/services/details/panel-brackets";

export default function PanelBracketsPricing() {
  const { pricingTitle, pricingDesc, pricingItems, pricingCalculatorPlaceholder, pricingActionText } = panel_bracketsDetails;
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto bg-gradient-to-r from-orange-55/80 to-orange-100/55 border border-orange-100 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center shadow-sm">
          <div className="md:w-1/2 w-full">
            ...
            {/* Семантическая HTML5 Таблица цен для отличного парсинга поисковиками и AI */}
            <div className="overflow-hidden rounded-2xl border border-orange-200/60 bg-white shadow-sm">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-orange-50/50 border-b border-orange-100">
                    <th className="p-4 text-xs font-bold uppercase tracking-wider text-slate-700">Тип конструкции</th>
