// app/services/panel-brackets/_components/PanelBracketsComparison.tsx
...
export default function PanelBracketsComparison() {
  const { comparisonTitle, comparisonDesc, comparisonA, comparisonB } = panel_bracketsDetails;
