// app/services/panel-brackets/_components/PanelBracketsHero.tsx
"use client";
...
interface PanelBracketsHeroProps {
  heroImages: string[];
}

export default function PanelBracketsHero({ heroImages }: PanelBracketsHeroProps) {
    ...
    <header id="hero" className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden border-b border-slate-200/80 bg-slate-50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <nav aria-label="Хлебные крошки" className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-slate-500 mb-8 font-medium">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
          <span className="text-orange-600 font-semibold">{panel_bracketsDetails.badge}</span>
        </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <p className="text-slate-600 text-lg mb-8 leading-relaxed max-w-xl">
              {panel_bracketsDetails.subtitle} Собственное производство двухсторонних консольных вывесок, высокая ветроустойчивость по СНиП и соответствие Дизайн-коду Астаны.
            </p>
      ...
      <ConsultationModal 
        ...
        source="Услуга: Панель-кронштейны"
        title="Заказать консультацию технолога"
        subtitle="Оставьте контакты, и наш специалист свяжется с вами для обсуждения вашего проекта."
