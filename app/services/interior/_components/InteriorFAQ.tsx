// app/services/interior/_components/InteriorFAQ.tsx

import { HelpCircle, ChevronDown, Clock, Drill, Plug } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 mb-4 tracking-tight">
            Популярные вопросы о логотипах в офис
          </h2>
          <p className="text-slate-500">
            Всё, что нужно знать перед тем, как заказать оформление ресепшена
          </p>
        </div>

        <div className="space-y-4">
          {interiorDetails.faqs.map((item, index) => (
            <details 
              key={index} 
              itemScope
              itemProp="mainEntity"
