// app/services/pylons/_components/PylonsFAQ.tsx
"use client";

import { HelpCircle, ChevronDown, ShieldCheck, Anchor, Construction } from "lucide-react";
...
export default function PylonsFAQ() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 mb-4 tracking-tight">
            Популярные вопросы о стелах
          </h2>
          <p className="text-slate-500">
            Всё, что нужно знать о проектировании, фундаментах и согласовании
          </p>
        </div>

        <div className="space-y-4">
          {pylonsDetails.faqs.map((item, index) => (
            <details 
              key={index} 
            ...
            >
              ...
              <div className="px-6 pb-6 pl-[4.5rem] text-slate-650 text-slate-600 text-sm leading-relaxed border-t border-slate-100 pt-4 animate-in fade-in slide-in-from-top-2 duration-200">
                <div>
                  {item.answer}
                </div>
              </div>
