// app/services/pylons/_components/PylonsPricing.tsx
"use client";
...
export default function PylonsPricing() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        <div className="bg-gradient-to-r from-orange-50 to-orange-100/50 border border-orange-100 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center shadow-sm">
            ...
            <div className="overflow-hidden rounded-2xl border border-orange-200/60 bg-white shadow-sm">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-sm text-slate-600">
                  {pylonsDetails.pricingItems.map((pr, i) => (
          ...
          <div className="md:w-1/2 text-center w-full">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Нужен проект или детальный расчет?</h3>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">
              Конструкция: {pylonsDetails.pricingCalculatorPlaceholder}. Консультация инженера и выезд на замер с геодезистом бесплатно.
            </p>
            <Link 
              href="/calculator" 
            ...
            >
              {pylonsDetails.pricingActionText}
            </Link>
          </div>
        </div>
      </div>
