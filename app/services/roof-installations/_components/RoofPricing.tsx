// app/services/roof-installations/_components/RoofPricing.tsx
"use client";
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100/50 border border-orange-100 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center shadow-sm">
          <div className="md:w-1/2 w-full">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-4 tracking-tight">
              {roof_installationsDetails.pricingTitle}
            </h2>
            <p className="text-slate-650 text-slate-650 text-sm md:text-base mb-6 leading-relaxed">
              {roof_installationsDetails.pricingDesc}
            </p>
            ...
            <div className="overflow-hidden rounded-2xl border border-orange-200/60 bg-white shadow-sm">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-sm text-slate-600">
                  {roof_installationsDetails.pricingItems.map((pr, i) => (
          ...
          <div className="md:w-1/2 text-center w-full">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Нужен индивидуальный расчет нагрузок?</h3>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">
              Тип конструкции: {roof_installationsDetails.pricingCalculatorPlaceholder}. Консультация инженера и выезд на замер бесплатно.
            </p>
            <Link 
              href="/calculator" 
            ...
            >
              {roof_installationsDetails.pricingActionText}
            </Link>
          </div>
        </div>
      </div>
