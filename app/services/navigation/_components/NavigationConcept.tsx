// app/services/navigation/_components/NavigationConcept.tsx

import { Signpost, LayoutDashboard, HelpCircle } from "lucide-react";
import Image from "next/image";
import { navigationDetails } from "@/dictionaries/services/details/navigation";

interface NavigationConceptProps {
...
export default function NavigationConcept({ fallbackImage }: NavigationConceptProps) {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              <h2 className="text-3xl font-extrabold text-slate-900 mb-6 tracking-tight">
                {navigationDetails.conceptTitle}
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                {navigationDetails.conceptDesc}
              </p>

              <div className="space-y-6">
                {navigationDetails.conceptHighlights.map((hl, i) => (
