// app/services/entrance-groups/_components/EntranceFAQ.tsx
"use client";

import { HelpCircle, ChevronDown, FileText, Frame, Construction } from "lucide-react";
import { entrance_groupsDetails } from "@/dictionaries/services/details/entrance-groups";

const IconMap = {
  FileText,
  Frame,
  Hammer: Construction, // Fallback safely to Construction
};
...
export default function EntranceFAQ() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 mb-4 tracking-tight">
            Популярные вопросы об оформлении входа
          </h2>
          <p className="text-slate-500">
            Всё, что нужно знать о согласовании, материалах и конструкции
          </p>
        </div>

        <div className="space-y-4">
          {entrance_groupsDetails.faqs.map((item, index) => (
            <details 
              key={index} 
