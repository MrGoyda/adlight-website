// app/services/facade-decoration/_components/FacadeDecorationFAQ.tsx

import { ShieldCheck, FileCheck, Zap, HelpCircle, ChevronDown } from "lucide-react";
...
export default function FacadeDecorationFAQ() {
  return (
    <section className="py-24 bg-slate-50 border-t border-slate-200/80">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500">Всё, что нужно знать об оформлении фасадов и брендировании витрин в Астане</p>
        </div>
        
        <div className="space-y-4">
          {facade_decorationDetails.faqs.map((item, index) => (
            <details 
              key={index} 
              itemScope
              itemProp="mainEntity"
