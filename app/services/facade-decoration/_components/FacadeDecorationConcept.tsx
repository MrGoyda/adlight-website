// app/services/facade-decoration/_components/FacadeDecorationConcept.tsx
...
interface FacadeDecorationConceptProps {
...
export default function FacadeDecorationConcept({ fallbackImage }: FacadeDecorationConceptProps) {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              <h2 className="text-3xl font-extrabold text-slate-900 mb-6 tracking-tight">
                {facade_decorationDetails.conceptTitle}
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                {facade_decorationDetails.conceptDesc}
              </p>

              <div className="space-y-6">
                {facade_decorationDetails.conceptHighlights.map((hl, i) => (
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 bg-slate-100 aspect-video group shadow-md">
              <Image 
                src={fallbackImage} 
                alt={facade_decorationDetails.title} 
                fill 
