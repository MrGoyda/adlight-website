...
export const getQuickWhatsAppTemplates = (clientName: string) => [
  {
    title: "Приветствие и консультация",
    text: `Здравствуйте, ${clientName}! Это компания ADLight по поводу вашего запроса на вывеску. Подскажите, пожалуйста, какие размеры и пожелания по дизайну?`,
  },
  {
    title: "Назначение замера",
    text: `Здравствуйте, ${clientName}! Можем направить нашего специалиста к вам на объект для проведения точного замера и фотопривязки. В какое время вам удобно встретиться?`,
  },
  {
    title: "Смета и КП готовы",
    text: `Здравствуйте, ${clientName}! Мы подготовили подробный сметный расчет и макет для вашей вывески. Отправляю на согласование!`,
  },
  {
    title: "Реквизиты для оплаты",
    text: `Здравствуйте, ${clientName}! Направляем реквизиты для внесения предоплаты (50%) для запуска заказа в производство.`,
  },
];
