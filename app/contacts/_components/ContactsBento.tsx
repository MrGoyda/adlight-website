          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             ...
             <FadeIn direction="up" delay={0.1} className="h-full">
               <address className="not-italic bg-white p-8 rounded-3xl border border-slate-200 hover:border-orange-500/50 hover:shadow-[0_15px_40px_rgba(249,115,22,0.04)] transition-all duration-300 group flex flex-col justify-between h-64 shadow-sm relative overflow-hidden">
                  ...
                  <div className="mt-auto">
                     <a href={`tel:${COMPANY_NAP.phoneRaw}`} className="text-3xl font-black text-slate-955 hover:text-orange-655 transition-colors block mb-6 tracking-tight leading-none">{COMPANY_NAP.phone}</a>
             ...
             <FadeIn direction="up" delay={0.2} className="h-full">
               <div className="bg-white p-8 rounded-3xl border border-slate-200 hover:border-blue-500/50 hover:shadow-[0_15px_40px_rgba(59,130,246,0.04)] transition-all duration-300 group flex flex-col justify-between h-64 shadow-sm relative overflow-hidden">
                  ...
                  <div className="mt-auto">
                     <p className="text-slate-955 font-black text-base mb-6 leading-tight">{dict.messengers.subtitle}</p>
             ...
             <FadeIn direction="up" delay={0.3} className="h-full">
               <div className="bg-white p-8 rounded-3xl border border-slate-200 hover:border-purple-500/50 hover:shadow-[0_15px_40px_rgba(168,85,247,0.04)] transition-all duration-300 group flex flex-col justify-between h-64 shadow-sm relative overflow-hidden">
                  <div className="flex justify-between items-start">
                  ...
                  <div className="mt-auto">
                     <div className="space-y-2 text-sm font-black text-slate-950">
                        <div className="flex justify-between border-b border-slate-200 pb-1.5"><span>{dict.schedule.weekdays}</span><span className="text-slate-955 font-black">09:00 - 18:00</span></div>
                        <div className="flex justify-between border-b border-slate-200 pb-1.5"><span>{dict.schedule.saturday}</span><span className="text-slate-955 font-black">09:00 - 14:00</span></div>
                        <div className="flex justify-between text-slate-900"><span>{dict.schedule.sunday}</span><span className="text-slate-900 font-bold">{dict.schedule.sundayOff}</span></div>
                     </div>
                  </div>
               </div>
             </FadeIn>
             ...
             <FadeIn direction="up" delay={0.4} className="h-full">
               <address className="not-italic bg-white p-8 rounded-3xl border border-slate-200 hover:border-pink-500/50 hover:shadow-[0_15px_40px_rgba(236,72,153,0.04)] transition-all duration-300 group flex flex-col justify-between h-64 shadow-sm relative overflow-hidden">
                  ...
                  <div className="mt-auto">
                     <a href={`mailto:${COMPANY_NAP.emailPersonal}`} className="text-xl font-black text-slate-955 hover:text-pink-655 transition-colors block mb-6 break-all tracking-tight leading-none">{COMPANY_NAP.emailPersonal}</a>
