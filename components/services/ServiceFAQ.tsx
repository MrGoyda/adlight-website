...
import { ChevronDown, HelpCircle, FileText, Shield, Calculator, Frame, Hammer, Zap, Plug, Eye } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500">
            Всё, что нужно знать об изготовлении, правилах согласования и монтаже вывесок
          </p>
        </div>
