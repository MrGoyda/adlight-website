...
export default function YandexMetrica() {
  return (
    <>
      {/* Скрипт инициализации (загружается с фоновой задержкой lazyOnload) */}
      <Script id="yandex-metrica" strategy="lazyOnload">
        {`
          // Delay Metrica execution slightly to allow Next.js hydration to finish without contention
          setTimeout(function() {
            ...
            // Disable heavy Webvisor on mobile devices to prevent 5-10s main thread freezes
